 ...
 * Switch Case Version 2- Use dependent, nested switch statements
 * Created on January 17, 2018, 2:11 PM
 */
            ...
            switch(hrsWrkd<0){
                ...
                default:
                    switch(hrsWrkd<=REGULAR_HOURS){
                        case true: paycheck = payRate * hrsWrkd;
                        break;
                        
                        default: paycheck = payRate * REGULAR_HOURS;
